...
<nav class="w3-sidebar w3-teal w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    <a href="../owner_homepage/owner_homepage.views.html" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Home</a> 
    <a href="../register_workplace/register_workplace2.views.html" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Registra tu negocio</a> 
